...
@interface ImageShopViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,BRScrollBarControllerDelegate>
...
@property (weak, nonatomic) IBOutlet UILabel *lbl_imageShop;
