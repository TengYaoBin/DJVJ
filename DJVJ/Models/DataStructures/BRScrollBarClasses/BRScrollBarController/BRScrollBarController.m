...
const CGFloat kBRScrollBarMarginTop   = 0;
const CGFloat kBRScrollBarMarginRight = 0;
...
- (CGPoint)scrollBarOriginForPosition:(BRScrollBarPostion)scrollBarPosition {
    ...
    if(scrollBarPosition == BRScrollBarPostionRight) {
        pointToreturn.x = self.scrollView.frame.origin.x + self.scrollView.frame.size.width - kIntBRScrollBarWidth;
        pointToreturn.x -= kBRScrollBarMarginRight;
    } else {
        pointToreturn.x  = self.scrollView.frame.origin.x +kBRScrollBarMarginRight;
    }
